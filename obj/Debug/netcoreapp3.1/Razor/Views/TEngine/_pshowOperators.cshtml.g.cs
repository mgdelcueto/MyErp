#pragma checksum "C:\Users\mgdel\VSProjects\MyErp\Views\TEngine\_pshowOperators.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b628ebee4b90d21c87379c2f7829fca33ca6ebf1"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b628ebee4b90d21c87379c2f7829fca33ca6ebf1", @"/Views/TEngine/_pshowOperators.cshtml")]
...
#line 3 "C:\Users\mgdel\VSProjects\MyErp\Views\TEngine\_pshowOperators.cshtml"
           Write(Html.LabelFor(p => p.OpeCode,new { @class = "norm-text",}));
...
#line 4 "C:\Users\mgdel\VSProjects\MyErp\Views\TEngine\_pshowOperators.cshtml"
           Write(Html.EditorFor(p => p.OpeCode, new { htmlAttributes = new { @class = "norm-text", @style = "width:150px" } }));
...
#line 11 "C:\Users\mgdel\VSProjects\MyErp\Views\TEngine\_pshowOperators.cshtml"
           Write(Html.LabelFor(p => p.OpeDesc,new { @class = "norm-text",}));
...
#line 12 "C:\Users\mgdel\VSProjects\MyErp\Views\TEngine\_pshowOperators.cshtml"
           Write(Html.EditorFor(p => p.OpeDesc, new { htmlAttributes = new { @class = "norm-text", @style = "width:450px" } }));
...
#line 13 "C:\Users\mgdel\VSProjects\MyErp\Views\TEngine\_pshowOperators.cshtml"
           Write(Html.LabelFor(p => p.OpeAcct,new { @class = "norm-text",}));
...
#line 14 "C:\Users\mgdel\VSProjects\MyErp\Views\TEngine\_pshowOperators.cshtml"
           Write(Html.EditorFor(p => p.OpeAcct, new { htmlAttributes = new { @class = "norm-text", @style = "width:200px" } }));
...
#line 23 "C:\Users\mgdel\VSProjects\MyErp\Views\TEngine\_pshowOperators.cshtml"
           Write(Html.LabelFor(p => p.OpeCosth,new { @class = "norm-text",}));
...
#line 24 "C:\Users\mgdel\VSProjects\MyErp\Views\TEngine\_pshowOperators.cshtml"
           Write(Html.EditorFor(p => p.OpeCosth, new { htmlAttributes = new { @class = "norm-text", @style = "width:200px" } }));
...
#line 25 "C:\Users\mgdel\VSProjects\MyErp\Views\TEngine\_pshowOperators.cshtml"
           Write(Html.LabelFor(p => p.OpeCurcy,new { @class = "norm-text" }));
